	...
	*/
	...
	if(c.playerEquipment[c.playerWeapon] == 861 && c.playerEquipment[c.playerArrows] == 9245){
			...
			if(c.playerEquipment[c.playerWeapon] == 861 && c.playerEquipment[c.playerArrows] == 9143){
                c.sendMessage("You cant use bolts with mage shortbow! // Monsterray Anti-Cheat");
                return;
	}
		...
		if(c.playerEquipment[c.playerWeapon] == 18357 && c.playerEquipment[c.playerArrows] == 892){
                c.sendMessage("You can't fire arrows with a crossbow // Monsterray Anti-Cheat");
                return;
	}
		...
		if(c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerArrows] == 15243){
                c.sendMessage("You can't fire hand cannon shots with a crossbow // Monsterray Anti-Cheat");
                return;
	}
		if(c.playerEquipment[c.playerWeapon] == 11235 && c.playerEquipment[c.playerArrows] == 9144){
                c.sendMessage("You can't use bolts with a bow! // Monsterray Anti-Cheat");
                return;
	}
	...
	if(c.playerEquipment[c.playerWeapon] == 18357 && c.playerEquipment[c.playerArrows] == 4740){
                c.sendMessage("You can't use bolt racks with chaotic crossbow! // Monsterray Anti-Cheat");
                return;
	}
		if(c.playerEquipment[c.playerWeapon] == 861 && c.playerEquipment[c.playerArrows] == 9244){
                c.sendMessage("You can't use bolts with a magic shortbow broski! // Monsterray Anti-Cheat");
                return;
	}
		...
		if(c.playerEquipment[c.playerWeapon] == 18357 && c.playerEquipment[c.playerArrows] == 15243){
                c.sendMessage("You cant fire hand cannon shots without the hand cannon! // Monsterray Anti-Cheat");
                return;
	}
			if(c.playerEquipment[c.playerWeapon] == 18357 && c.playerEquipment[c.playerArrows] == 15243){
                c.sendMessage("You cant fire hand cannon shots without the hand cannon! // Monsterray Anti-Cheat");
		...
		if(c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerArrows] == 9245){
                c.sendMessage("Only Chaotic Crossbow has the strength to fire these powerful bolts. // Monsterray Anti-Cheat");
                return;
					}
		if(c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerArrows] == 11212){
                c.sendMessage("You can't fire D Arrows with Crossbows!. // Monsterray Anti-Cheat");
                return;
									}
		...
		if(c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerArrows] == 890){
                c.sendMessage("You can't fire arrows with a crossbow // Gabbe Anti-Cheat");
                return;
					}
		...
		if(c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerArrows] == 882){
			...
			if(c.playerEquipment[c.playerWeapon] == 4734 && c.playerEquipment[c.playerArrows] == 9244){
                c.sendMessage("You can't fire bolts with this crossbow, only bolt rack!// Monsterray Anti-Cheat");
                return;
	}
                ...
                c.sendMessage("You can't fire bolts with this crossbow, only bolt rack!// Gabbe Anti-Cheat");
                return;
	}//HERE STARTS CHAOTIC CROSS WITH ARROWS // GABBE CHEAP FIX
...
c.sendMessage("You need Bolt Rack for Karil's Crossbow! // Gabbe anti cheat");
return;
}
...
if(NPCHandler.npcs[i].index != c.playerId || c.wildLevel <= 1) {
				resetPlayerAttack();
...
c.degradeSHelm();
	...
	/**
	* Attack Players, same for Monsterray`s Castlewars :D
	**/
	...
	if(c.playerEquipment[c.playerWeapon] == 861 && c.playerEquipment[c.playerArrows] == 9245){
			...
			if(c.playerEquipment[c.playerWeapon] == 861 && c.playerEquipment[c.playerArrows] == 9143){
                c.sendMessage("You cant use bolts with mage shortbow! // Gabbe Anti-Cheat");
                return;
	}
			if(c.playerEquipment[c.playerWeapon] == 861 && c.playerEquipment[c.playerArrows] == 9142){
                c.sendMessage("You cant use bolts with mage shortbow! // Gabbe Anti-Cheat");
		...
		if(c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerArrows] == 11212){
                c.sendMessage("You can't fire D Arrows with Crossbows!. // Gabbe Anti-Cheat");
                return;
									}
		if(c.playerEquipment[c.playerWeapon] == 18357 && c.playerEquipment[c.playerArrows] == 11212){
                c.sendMessage("You can't fire D Arrows with Crossbows!. // Gabbe Anti-Cheat");
		...
		if(c.playerEquipment[c.playerWeapon] == 9185 && c.playerEquipment[c.playerArrows] == 15243){
                c.sendMessage("You can't fire hand cannon shots with a crossbow // Gabbe Anti-Cheat");
                return;
	}
		if(c.playerEquipment[c.playerWeapon] == 11235 && c.playerEquipment[c.playerArrows] == 9144){
                c.sendMessage("You can't use bolts with a bow! // Gabbe Anti-Cheat");
                return;
	}
	if(c.playerEquipment[c.playerWeapon] == 11235 && c.playerEquipment[c.playerArrows] == 9245){
                c.sendMessage("You can't use bolts with a bow! // Gabbe Anti-Cheat");
	...
	if(c.playerEquipment[c.playerWeapon] == 18357 && c.playerEquipment[c.playerArrows] == 4740){
                c.sendMessage("You can't use bolt racks with chaotic crossbow! // Gabbe Anti-Cheat");
                return;
	}
		if(c.playerEquipment[c.playerWeapon] == 861 && c.playerEquipment[c.playerArrows] == 9244){
                c.sendMessage("You can't use bolts with a magic shortbow broski! // Gabbe Anti-Cheat");
                return;
	}
			if(c.playerEquipment[c.playerWeapon] == 861 && c.playerEquipment[c.playerArrows] == 9243){
                c.sendMessage("You can't use bolts with a magic shortbow broski! // Gabbe Anti-Cheat");
		...
		if(c.playerEquipment[c.playerWeapon] == 18357 && c.playerEquipment[c.playerArrows] == 15243){
                c.sendMessage("You cant fire hand cannon shots without the hand cannon! // Gabbe Anti-Cheat");
                return;
	}
			if(c.playerEquipment[c.playerWeapon] == 18357 && c.playerEquipment[c.playerArrows] == 15243){
                c.sendMessage("You cant fire hand cannon shots without the hand cannon! // Monsterray Anti-Cheat");
	...
	public void appendVengeanceNPC(int otherPlayer, int damage) {
		...
		if (c.npcIndex > 0 && NPCHandler.npcs[c.npcIndex] != null) {
			...
			if ((NPCHandler.npcs[c.npcIndex].HP - damage) > 0) {
				...
				NPCHandler.npcs[c.npcIndex].CIcon = 2; 
...
break;
      ...
      NPCHandler.npcs[c.npcIndex]; if(opp != null) opp.gfx0(1224); }
