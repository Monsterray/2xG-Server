...
public class Potions {
	...
	/**
	 * Does what ever the potion that was used to actualy be used correctly
	 * @param itemId is the items Id
	 * @param slot is the slot from which the item was used
	 */
	...
	/**
	 * Overloads the player
	 * @param itemId not used
	 * @param replaceItem not used
	 * @param slot not used
	 */
	...
	/**
	 * Figures out how long to give you the overload
	 */
	...
	/**
	 * Figures out how much boost the potion gives to your skills
	 */
	...
	/**
	 * Gets rid of the poison effect
	 * @param itemId The items ID number that is used
	 * @param replaceItem 
	 * @param slot The slot from witch the item was used
	 * @param delay
	 */
