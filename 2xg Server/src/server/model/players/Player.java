...
public abstract class Player {
	...
	**/
	...
	//BOUNTY HUNTER
	/*public int bountyHunterTarget;
	public int enterBHTime;
	
	public int leavePenalty;
	public int pickupPenalty;*/
	...
	public boolean inBountyHunterCombat() {
		return false; // TODO: Inside caves
	}
	public boolean inBountyHunterWait() {
		return false; // TODO: Inside waiting area(not made yet)
	}*/
	
	//start of barbarian assult
	...
	public final int[] BOWS = 	{18357,15241,9185,839,845,847,851,855,859,841,843,849,853,857,861,4212,4214,4215,11235,4216,4217,4218,4219,4220,4221,4222,4223,6724,4734,4934,4935,4936,4937};
...
if(absX > 3199 && absX < 3264 && absY > 9278 && absY < 9337 || absX > 3013 && absX < 3036 && absY > 5214 && absY < 5249) {	
                      return true;
		}
		return false;
	}	
