...
public class Region {
    ...
    public static void load() {
    	try {
			File f = new File("./deps/Data/data/map_index");
			...
			for (int i = 0; i < size; i++) {
				byte[] file1 = ReadFile(("./deps/Data/data/map/" + mapObjectsFileIds[i] + ".dat"));
				byte[] file2 = ReadFile(("./deps/Data/data/map/" + mapGroundFileIds[i] + ".dat"));
			...
			System.out.println("[Server] Finished Loading 2xG Maps");
			System.out.println("[Server] 2xG is Now Online!");
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    }
