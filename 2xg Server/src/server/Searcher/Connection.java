...
public class Connection {
	...
	**/
	...
	public static void unMuteUser(String name) {
		...
		deleteFromFile("./deps/Data/bans/UsersMuted.txt", name);	
	}
	
	public static void unIPMuteUser(String name) {
		mutedIps.remove(name);
		deleteFromFile("./deps/Data/bans/IpsMuted.txt", name);	
	}
	...
	**/
	public static void removeNameFromBanList(String name) {
		...
		deleteFromFile("./deps/Data/bans/UsersBanned.txt", name);
	}
	...
	**/
	public static void banUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./deps/Data/bans/UsersBanned.txt"));
			String data = null;
			try {
	...
	public static void muteUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./deps/Data/bans/UsersMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedNames.add(data);
	...
	**/
	public static void banIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./deps/Data/bans/IpsBanned.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					addIpToBanList(data);
	...
	public static void muteIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./deps/Data/bans/IpsMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedIps.add(data);
...
public static void appendStarters() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./deps/data/tradesandothers/starters/FirstStarterRecieved.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
	...
	public static void appendStarters2() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./deps/data/tradesandothers/starters/SecondStarterRecieved.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
	...
	public static void addIpToStarterList1(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./deps/data/tradesandothers/starters/FirstStarterRecieved.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	public static void addIpToStarterList2(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./deps/data/tradesandothers/starters/SecondStarterRecieved.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	**/
	public static void addNameToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./deps/Data/bans/UsersBanned.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	public static void addUserToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./deps/Data/bans/UsersMuted.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	**/
	public static void addIpToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./deps/Data/bans/IpsBanned.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	public static void addIpToMuteFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./deps/Data/bans/IpsMuted.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
